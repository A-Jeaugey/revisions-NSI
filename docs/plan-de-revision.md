...
|------|--------------|-------------------|---------------|
| **J-30** | [01 Python](fiches/01_python_remise_en_route.md) | TP : refaire 5 exos Capytale séq 1 | Flashcards vocabulaire |
| **J-29** | [02 Récursivité](fiches/02_recursivite.md) | Coder factorielle, Fibonacci, Hanoï | Flashcards récursivité |
| **J-28** | [03 ADT](fiches/03_types_abstraits_donnees.md) — Piles | Implémenter pile + calculatrice polonaise inversée | Quiz pile/file |
| **J-27** | [03 ADT](fiches/03_types_abstraits_donnees.md) — Files + Listes chaînées | Implémenter file (deque) + liste chaînée | — |
| **J-26** | [04 POO](fiches/04_programmation_orientee_objet.md) | Coder classe `Pile` puis classe `CompteBancaire` | Diagrammes UML |
...
|------|-------|------------|------|
| **J-23** | [05 Graphes](fiches/05_graphes.md) | Coder représentation par dict + BFS | [Diagramme parcours](diagrammes/parcours_graphes.md) |
| **J-22** | [05 Graphes](fiches/05_graphes.md) — DFS, applications | Coder DFS récursif + détection de cycle | — |
| **J-21** | [06 Arbres](fiches/06_arbres.md) | Coder ABR : insertion, recherche, parcours | [Diagramme arbres](diagrammes/arbres_terminologie.md) |
| **J-20** | [08 Diviser pour régner](fiches/08_diviser_pour_regner.md) | Coder tri fusion + tri rapide + dichotomie | Flashcards complexités |
| **J-19** | [12 Glouton + KNN](fiches/12_glouton_knn.md) | Rendu de monnaie + sac à dos fractionnaire | — |
| **J-18** | [13 Prog. dynamique](fiches/13_programmation_dynamique.md) | Fibonacci mémoïsé + sac à dos 0/1 | Flashcards DP |
...
| Jour | Matin | Après-midi | Soir |
|------|-------|------------|------|
| **J-16** | [07 BDD](fiches/07_bases_de_donnees.md) — modèle relationnel | TD modèles relationnels (PDFs) | [Cheat-sheet SQL](memos/memo_sql_bac.md) |
| **J-15** | [07 BDD](fiches/07_bases_de_donnees.md) — SQL | Faire 15 requêtes SQL variées (SELECT/JOIN/GROUP) | Flashcards SQL |
| **J-14** | [09 Processus](fiches/09_processus.md) | Schéma états-processus + interblocage | [Diagramme états](diagrammes/etats_processus.md) |
| **J-13** | [10 Linux](fiches/10_linux.md) | Pratique terminal : 30 commandes en boucle | Cheat-sheet Linux |
| **J-12** | [11 Réseaux](fiches/11_reseaux.md) — OSI/TCP-IP, IP | Exos calcul masque/sous-réseau | [Diagramme OSI](diagrammes/modele_osi_tcpip.md) |
| **J-11** | [11 Réseaux](fiches/11_reseaux.md) — TCP/UDP, encapsulation | Exos questions de cours type bac | — |
...
| Jour | Matin | Après-midi | Soir |
|------|-------|------------|------|
| **J-9** | [14 Cryptographie](fiches/14_cryptographie.md) | Coder César + Vigenère + comprendre RSA | — |
| **J-8** | [15 SoC](fiches/15_soc.md) | Cycle d'instruction + von Neumann | — |
| **J-7** | [16 Recherche textuelle](fiches/16_recherche_textuelle.md) | Coder algo naïf + KMP (lecture) | — |
| **J-6** | [17 Paradigmes](fiches/17_paradigmes_programmation.md) | Comparer impératif / fonctionnel sur 3 exemples | — |
| **J-5** | [18 Approfondissement](fiches/18_approfondissement.md) | Quiz transverse + révision complexités | [Memo complexités](memos/memo_complexites.md) |
